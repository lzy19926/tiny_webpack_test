import { render, myUseEffect } from '../../lzy-React/out/index_V3'
import * as LzyReact from '../../lzy-React/out/index_V3'

function Link(props, children, fiber) {

    console.log(fiber, 'link对应的fiber');
    const { to, title, component } = props
    ...
    function switchRouteHistory() {
        ...
        const domContainer = document.getElementById('routeContainer')
    ...
    return (<a href={to} onClick={handleRouteChange} > ${title} </a>)
}
