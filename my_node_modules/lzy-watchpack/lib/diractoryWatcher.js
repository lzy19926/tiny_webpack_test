...
//1.保存fileWatcher
//2. 遍历scan  fileWatcher
const watcher = new DirectoryWatcher()

//1. 检查文件变化
//2. 触发对应事件
[new FileWatcher(), new FileWatcher(), new FileWatcher(), new FileWatcher()]
...
watcher.on('CHANGE', () => { console.log('热更新'); })

watcher.on('REMOVE', () => { console.log('热更新'); })

watcher.on('CREATE', () => { console.log('热更新'); })
