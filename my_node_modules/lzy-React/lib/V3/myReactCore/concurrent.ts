...
export class WhileCodeCutter {
  ...
  performWorkUntilDeadline() {
    logger.log(`执行单个${this.yieldInterval}ms的任务`);
...
export function after_FiberNodeMutation_Hook(callback: Function) {
  concurrentWhileHook.afterFiberNodeMutation = callback
}