...
import { hasKey } from '../myReactCore/utils'
...
export function updateReconcileElement(newEle: ElementNode, oldEle: ElementNode): { isSameNode: boolean, newEle: ElementNode } {
    ...
    // 继续向下 组件vnode   挂载props
    if (newEle.tag[0] === newEle.tag[0].toUpperCase()) {
        const childElement = newEle.ref.call(undefined, newEle.props)
