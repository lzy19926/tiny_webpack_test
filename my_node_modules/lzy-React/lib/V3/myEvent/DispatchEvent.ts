...
export function dispatchEvent(
    ...
    processDispatchQueue(dispatchQueue, true); // 这里isCapture变量写死了  需修改
...
function accumulateEventListeners(
    ...
    if (reactName === undefined) return listeners;
...
function processDispatchQueue(dispatchQueue: DispatchQueue, isCapture: boolean) {
