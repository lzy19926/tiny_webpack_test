...
function mountImperativeHandleImpl(ref: Function | { current: any }, create: Function) {
 ...
 * *****************************************************************************************/
export function mountImperativeHandle(ref: Function | { current: any }, create: Function, deps: any[]) {
  ...
  return myUseEffect(mountImperativeHandleImpl.bind(null, ref, create), deps)
}