...
function mountEffect(fiberFlag: string, hookFlags: string, create: Function, deps: any[] | null) {
...
function updateEffect(fiberFlag: string, hookFlags: string, create: Function, deps: any[] | null) {
  const fiber = global.workInprogressFiberNode//! 测试
...
function shallowCompareDeps(nextDeps: any[], prveDeps: any[]) {
  ...
  logger.log('前后dep对比', prveDeps, nextDeps);
...
function myUseEffect(create: Function, deps?: any[]) {
  ...
  } else if (fiber.fiberFlag === 'update') {
