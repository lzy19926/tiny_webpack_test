...
export function createFiberTree_base(elementNode: ElementNode | TextElementNode, parentFiber: FiberNode): FiberNode {
...
export function createFiberTree(elementNode: ElementNode | TextElementNode, parentFiber: FiberNode): FiberNode {
    ...
    const rootFiber = createFiberTree_base(elementNode, undefined)
