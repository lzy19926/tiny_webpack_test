...
function firstRenderPart(functionComponent: any, rootDom: HTMLElement) {
    ...
    const rootFiber = createFiberTree(elementTree)
...
function commitPart(finishedWorkFiber: FiberNode) {
    ...
    commitFiberNodeMutation_noConcurrent(global.EffectList) //  mutation阶段 
...
function commitFiberNodeMutation_noConcurrent(EffectList: any, lane?: any) {
