...
exports.linkRender = void 0;
const GlobalFiber_1 = require("./GlobalFiber");
const tplToVnode_1 = require("../myJSX/tplToVnode");
//!--------------综合Render方法-------------------
function linkRender(functionComponent, rootDom, initFiber) {
...
function linkRenderPart(functionComponent, initFiber) {
...
//todo commit
function linkCommitPart(fiber, rootDom) {
...
function createHtml(fiber, rootDom) {
    ...
    if (fiber.next && fiber.next.parentFiberNode === fiber) {
        ...
        if (fiber.next) {
            createHtml(fiber.next, parentDom);
        }
    }
