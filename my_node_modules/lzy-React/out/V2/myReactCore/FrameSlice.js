...
exports.concurrentWhile = exports.performWorkUntilDeadline = exports.requestHostCallback = exports.shouldYieldToHost = void 0;
...
const shouldYieldToHost = () => getCurrentTime() >= deadLine; // 超过deadLine时让出JS主线程给用户
exports.shouldYieldToHost = shouldYieldToHost;
// 建立通信
// port用来发布任务
...
exports.performWorkUntilDeadline = performWorkUntilDeadline;
//!  --------------切片执行while循环函数---------------
// 使用说明  
...
function concurrentWhile(getCondition, handler, yieldInterval) {
    ...
    // 创建whild循环体
    let workLoop = () => {
        while (!(0, exports.shouldYieldToHost)() && getCondition()) {
            handler();
        }
        // 如果未完成while 继续切片执行
        return getCondition();
