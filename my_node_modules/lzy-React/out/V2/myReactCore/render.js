...
function firstRenderPart(functionComponent, rootDom) {
    ...
    const rootFiber = (0, createFiberTree_1.createFiberTree)(elementTree);
    return rootFiber;
}
...
function commitPart(finishedWorkFiber) {
    ...
    commitFiberNodeMutation_noConcurrent(GlobalFiber_1.global.EffectList); //  mutation阶段 
...
function commitFiberNodeMutation_noConcurrent(EffectList, lane) {
...
function commitFiberNodeMutation_concurrent(EffectList, lane) {
    console.log('本次更新的EffectList', EffectList);
    const getCondition = () => EffectList.firstEffect !== null;
