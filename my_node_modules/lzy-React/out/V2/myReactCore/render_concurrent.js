...
exports.updateRender_concurrent = exports.render_concurrent = void 0;
...
function firstRenderPart(functionComponent, rootDom) {
    ...
    const rootFiber = (0, createFiberTree_1.createFiberTree_concurrent)(elementTree);
    return rootFiber;
}
...
function updateRenderPart(functionComponent, workInProgressFiber, currentFiber) {
    ...
    const workInProgressRootFiber = (0, updateFiberTree_1.updateFiberTree_concurrent)(newElementTree, workInProgressFiber, currentFiber, 'rootUpdateFiber');
...
//! ----------------首屏渲染----------------------------
function render_concurrent(functionComponent, rootDom) {
...
exports.render_concurrent = render_concurrent;
//! ----------------综合updateRender方法-------------------
function updateRender_concurrent(functionComponent, workInProgressFiber, currentFiber) {
    ...
    (0, concurrent_1.afterUpdateRender)(() => {
...
exports.updateRender_concurrent = updateRender_concurrent;
