...
exports.createFiberWorkLoop = exports.createFiberWorkLoop2 = exports.handleProps = exports.createTextElement = exports.createDomElement = exports.createAlternate = exports.createFiberTree2 = exports.createFiberTree3 = exports.createFiberTree = void 0;
...
//! ------------初始创建fiberTree-------------------
function createFiberTree(rootElement) {
    let start = Date.now();
    //todo------- 遍历二叉element树----
    const stack = [];
    let prevFiber;
    ...
    const workLoop = (shouldContinue, initialTime) => {
        while (!shouldYieldToHost() && stack.length) {
            ...
            if (from === 'child') {
                prevFiber._child = currentFiber;
            }
            else if (from === 'sibling') {
                prevFiber._sibling = currentFiber;
            }
            ...
            if (!stack.length) {
                ...
                GlobalFiber_1.global.isFirstRenderDone = true;
            }
        }
        if (stack.length) {
...
//! ------------初始创建fiberTree-------------------
function createFiberTree3(rootElement) {
    let start = Date.now();
    //todo------- 遍历二叉element树----
    const stack = [];
    let prevFiber;
...
exports.createFiberTree3 = createFiberTree3;
//!------ 单独处理创建AppFiber节点
...
//! ---------------初始创建fiberTree(废弃)--------------------
function createFiberTree2(elementNode, parentFiber) {
    let newFiberNode = new GlobalFiber_1.FiberNode('mount', '$1');
    let childElement = elementNode._child;
    let siblingElement = elementNode._sibling;
    //todo 切换当前工作fiber
...
exports.createFiberTree2 = createFiberTree2;
//! -------------创建复制的alternate------------------
