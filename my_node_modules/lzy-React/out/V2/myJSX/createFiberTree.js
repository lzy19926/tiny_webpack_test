...
exports.createFiberWorkLoop = exports.createFiberWorkLoop2 = exports.handleProps = exports.createTextElement = exports.createDomElement = exports.createAlternate = exports.createFiberTree = exports.createAlternate2 = void 0;
...
//! -------------创建复制的alternate------------------
function createAlternate2(currentFiber) {
...
exports.createAlternate2 = createAlternate2;
//! ------------初始创建fiberTree-------------------
function createFiberTree(rootElement) {
    ...
    rootFiberAlt = currentAlt = createAlternate2(current);
    // 从App的child开始遍历
    ...
    (0, concurrent_1.concurrentWhile)(getCondition, () => {
        ...
        //创建alternate
        currentAlt = createAlternate2(current);
