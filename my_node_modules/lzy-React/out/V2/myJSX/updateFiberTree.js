...
exports.updateFiberTree_concurrent = exports.updateFiberTree = void 0;
...
function updateFiberTree(newElementNode, workInProgressFiber, tag) {
    //todo 删除节点逻辑
    if (!newElementNode) {
...
function updateFiberTree_concurrent(newElementNode, workInProgressFiber, currentFiber, tag) {
    // 首先处理跟节点  不遍历根节点的sibling
    //todo------- 遍历二叉element树----
    const stack = [];
    let prevFiber;
    let rootFiber = workInProgressFiber;
    ...
    (0, concurrent_1.concurrentWhile)(getCondition, () => {
        ...
        if (newElementNode && !workInProgressFiber) {
            ...
            const newFiber = (0, createFiberTree_1.createFiberTree)(newElementNode, parentFiber);
            const newAltFiber = (0, createFiberTree_1.createAlternate)(newFiber);
        ...
        if (siblingElement && tag !== 'rootUpdateFiber') { // (不需要更新跟组件节点的sibling节点)) {
            ...
            stack.push({
                ...
                workInProgressFiber: workInProgressFiber._sibling,
        ...
        if (!getCondition()) {
            ...
            concurrent_1.concurrentWhileHook.afterUpdateRender();
        }
    });
    return rootFiber;
}
exports.updateFiberTree_concurrent = updateFiberTree_concurrent;
// 更新单个workInFiber
function updateFiber(newElementNode, workInProgressFiber, currentFiber) {
    // 链接element和节点
