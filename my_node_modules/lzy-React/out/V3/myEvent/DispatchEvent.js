...
function accumulateTowEventListeners(targetFiber, domEventName, nativeEventTarget) {
    ...
    while (currentFiber) {
        ...
        isHost && nativeListener && listeners.push(newDispatchListener(currentFiber, nativeListener, nativeEventTarget));
        isHost && nativeListenerCapture && capturedListeners.push(newDispatchListener(currentFiber, nativeListenerCapture, nativeEventTarget));
