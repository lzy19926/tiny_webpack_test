...
exports.updateEffect = exports.mountEffect = void 0;
...
//! ------浅比较前后deps是否发生变化-------------------
function shallowCompareDeps(nextDeps, prevDeps) {
    logger_1.logger.log('前后dep对比', prevDeps, nextDeps);
    // 选取最大的lenght
...
function mountEffect(create, deps) {
    const fiber = GlobalFiber_1.global.workInprogressFiberNode;
