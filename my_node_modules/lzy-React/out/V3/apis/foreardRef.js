 ...
 * 于markRef的时候记录ref
 * 在render阶段创建fiber节点时(renderElement)， 将该类型节点的render函数取出执行,注入ref
...
function forwardRef(render) {
    ...
    //@ts-ignore
    if ((render === null || render === void 0 ? void 0 : render.$$typeof) === elementType_1.ET.MEMO_TYPE) {
        console.error(`
    ...
    const newElementType = {
        $$typeof: Symbol.for(elementType_1.ET.FORWARD_REF_TYPE),
        render
    };
