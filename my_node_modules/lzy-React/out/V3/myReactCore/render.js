...
const reconcileWork_1 = require("../myJSX/reconcileWork");
...
function resetFiberEffect(workInProgressFiber, currentFiber) {
...
function updateRender(functionComponent, workInProgressFiber, currentFiber) {
    ...
    const { newEle } = (0, reconcileWork_1.reconcileWork_sync)(newRootElement, oldRootElement); // 新老ele进行调和(生成element树 转换为二叉fiber树)
