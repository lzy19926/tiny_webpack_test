...
exports.after_FiberNodeMutation_Hook = exports.after_FirstReconcile_Hook = exports.after_UpdateReconcile_Hook = exports.concurrentWhileHook = exports.concurrentWhile = exports.WhileCodeCutter = void 0;
...
class WhileCodeCutter {
    ...
    performWorkUntilDeadline() {
        logger_1.logger.log(`执行单个${this.yieldInterval}ms的任务`);
...
function concurrentWhile(getCondition, handler, yieldInterval, afterWhile) {
    ...
    const performWorkUntilDeadline = () => {
        logger_1.logger.log(`-----${yieldInterval}ms切片-----`);
        // 如果没有用户任务  状态直接改为false
...
exports.concurrentWhileHook = {
    ...
    afterFiberNodeMutation: undefined
};
// 注册钩子函数
function after_UpdateReconcile_Hook(callback) {
    exports.concurrentWhileHook.afterUpdateReconcile = callback;
}
exports.after_UpdateReconcile_Hook = after_UpdateReconcile_Hook;
function after_FirstReconcile_Hook(callback) {
    exports.concurrentWhileHook.afterFirstReconcile = callback;
}
exports.after_FirstReconcile_Hook = after_FirstReconcile_Hook;
function after_FiberNodeMutation_Hook(callback) {
    exports.concurrentWhileHook.afterFiberNodeMutation = callback;
}
exports.after_FiberNodeMutation_Hook = after_FiberNodeMutation_Hook;
