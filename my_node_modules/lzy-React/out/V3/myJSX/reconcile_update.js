...
function updateReconcileElement(newEle, oldEle) {
    ...
    if ((0, utils_1.isFunctionElement)(newEle)) {
    ...
    if (newEle.children && newEle.children.length > 0) {
        ...
        if (i <= newEle.children.length) {
            ...
            for (let k = i; k < newEle.children.length; k++) {
                ...
                // map中找到则拿来复用
                if ((0, utils_2.hasKey)(newChildEle) && fiberMap.has(newChildEle.key)) {
                ...
                else if ((0, utils_2.hasKey)(newChildEle) && !fiberMap.has(newChildEle.key)) {
