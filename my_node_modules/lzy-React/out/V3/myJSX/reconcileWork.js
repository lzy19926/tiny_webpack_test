...
function reconcileElement(rootElement, parentFiber, prevSibling) {
    ...
    while (stack.length > 0) {
        ...
        const workInProgressFiber = (0, renderWork_1.renderElement)(element, parentFiber, prevSiblingFiber);
        // 继续执行
...
function updateReconcileElement(newEle, oldEle) {
    ...
    if ((0, elementType_1.isFunctionEle)(newEle)) {
        const childElement = newEle.render.call(undefined, newEle.props, newEle.children, newEle.fiber);
