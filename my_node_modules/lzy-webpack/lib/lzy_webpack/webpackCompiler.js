...
class Webpack {
    ...
    createAssets(absolutePath) {
        ...
        traverse(ast, {
            ImportDeclaration: (path, state) => {//todo 遇到import语句  将文件路径push到依赖数组(补全.js后缀  删除.css引入)
            ...
            CallExpression: (path, state) => {
                ...
                if (idName === 'require') {   //todo 遇到require语句  将文件路径push到依赖数组(补全.js后缀  删除.css引入)
                    const depRaletivePath = this.addFileSuffix(path.node.arguments[0].value)
