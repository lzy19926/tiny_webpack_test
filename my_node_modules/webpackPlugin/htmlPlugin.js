...
class HtmlPlugin {
    constructor({ template, fileName }) {
        ...
        this.htmlTemplate = this.getHtml(template) || initHtmlTpl
    }
    ...
    run(compilation) {
        ...
        const createHtmlFn = this.createHtml.bind(this, compilation.config)
        compilation.hooks.afterDistSync.tap("htmlPlugin", createHtmlFn)
    }
}
