...
var _lzyReactDevelpoment = require("../my_node_modules/lzy-React/lzy-react-develpoment.js");

// import { App, render } from './tinyReact/App.lzy'
(0, _lzyReactDevelpoment.render)(_Demo.Demo, document.getElementById('root')); // render(App, document.getElementById('root'))
        } ,
 {"./tinyReact/Demo.lzy":"E:\\My_Webpack\\myWebpack\\src\\tinyReact\\Demo.lzy","../my_node_modules/lzy-React/lzy-react-develpoment.js":"E:\\My_Webpack\\myWebpack\\my_node_modules\\lzy-React\\lzy-react-develpoment.js"} 
 ],
...
function Demo(props) {
 ...
 {"../../my_node_modules/lzy-React/lzy-react-develpoment.js":"E:\\My_Webpack\\myWebpack\\my_node_modules\\lzy-React\\lzy-react-develpoment.js","./Demo.css":"E:\\My_Webpack\\myWebpack\\src\\tinyReact\\Demo.css"} 
 ],
"E:\\My_Webpack\\myWebpack\\my_node_modules\\lzy-React\\lzy-react-develpoment.js":[
 (require,module,exports)=>{
            "use strict";
...
function tplToVDOM(html) {
 ...
 {} 
            ...
            //todo 这里需要一个module缓存 (需要从缓存里取变量 不然会导致无法通过引用修改变量问题)
            var modulesCache = {};
            ...
            function require(absolutePath){
                ...
                //! 将三个参数传入fn并执行
                fn.apply(window, [loaclRequire, module, module.exports])
